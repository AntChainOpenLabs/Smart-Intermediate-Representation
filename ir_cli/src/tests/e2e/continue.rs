...
fn test_simple_contract_with_continue() {
    let mut runtime_and_abi = build_mock_runtime(
        ...
        contract continueTest {
            ...
            pub fn continueTest.continueTest.init()  {
                0:
                    ret()
            }

            pub fn continueTest.continueTest.continueTest(%0: u64, ) -> u64 {
                1:
                ...
                3:
                    %2 !ir_debug_location !3 = add(%2: u64, 1: u64, )
                    br_if(lt(%2: u64, 10: u64, ) , bb 5, bb 6, ) !ir_debug_location !4
                4:
                    ret(%1: u64, ) !ir_debug_location !7
                5:
                    br(bb 2, ) !ir_debug_location !5
                6:
                    %1 !ir_debug_location !6 = add(%1: u64, 5: u64, )
        ...
        meta !2 = !{6: u32, 13: u32, "test.sonar": str, }
...
#[test]
fn simple_vector_for_with_continue() {
    let mut runtime_and_abi = build_mock_runtime(
        ...
        contract SimpleVectorContract {
            ...
            pub fn SimpleVectorContract.SimpleVectorContract.simple_vector(%0: [u64], ) -> u64 {
                ...
                3:
                    ...
                    br_if(eq(%1: u64, 10: u64, ) , bb 5, bb 6, ) !ir_debug_location !5
                4:
                    ret(%1: u64, ) !ir_debug_location !8
                5:
                    br(bb 2, ) !ir_debug_location !6
                6:
                    %1 !ir_debug_location !7 = add(%1: u64, %3: u64, )
        ...
        meta !7 = !{12: u32, 12: u32, "test.sonar": str, }
