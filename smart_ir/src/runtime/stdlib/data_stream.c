...
DATA_STREAM_ENCODE_INT_DECLARE(u256, uint256_t)
...
DATA_STREAM_ENCODE_INT_DECLARE(i256, int256_t)
...
DATA_STREAM_DECODE_INT_DECLARE(u256, uint256_t)
...
DATA_STREAM_DECODE_INT_DECLARE(i256, int256_t)
...
DATA_STREAM_ENCODE_INT_ARRAY_DECLARE(u256, uint256_t)
...
DATA_STREAM_ENCODE_INT_ARRAY_DECLARE(i256, int256_t)
...
DATA_STREAM_DECODE_INT_ARRAY_DECLARE(u256, uint256_t)
...
DATA_STREAM_DECODE_INT_ARRAY_DECLARE(i256, int256_t)
...
DATA_STREAM_ENCODE_STR_INT_MAP_DECLARE(u256, uint256_t)
...
DATA_STREAM_ENCODE_STR_INT_MAP_DECLARE(i256, int256_t)
...
DATA_STREAM_DECODE_STR_INT_MAP_DECLARE(u256, uint256_t)
...
DATA_STREAM_DECODE_STR_INT_MAP_DECLARE(i256, int256_t)
    ...
    while (qhashtbl_getnext(v, &obj, true) == true) {
        ...
        if (TABLE_KEY_IS_INT(v)) {
            switch (v->key_runtime_ty) {
                ...
                case IR_RUNTIME_TYPE_U256: str_n = 32; break;
                ...
                case IR_RUNTIME_TYPE_I256: str_n = 32; break;
                default: {
